void bomber_init(Bomber* bomber) {
	// TODO: implement
}

void bomber_update(Game* game, Windowing::Context* window) {
	// Selection control
	i32 selection_pos[3];
...
void bomber_color_cube(Game* game, i32 cube_index, i32* render_position, f32* color) {
	// TODO: implement
}

void bomber_render(Game* game, Render::Context* renderer, Windowing::Context* window) {
	// TODO: implement
}
